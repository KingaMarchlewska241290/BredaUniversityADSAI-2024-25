...
def init_clearml(project: str, task_name: str, tags: list[str]):
    ...
    try:
        ...
        # Optional: pin/force requirements on the remote agent to avoid numpy/pandas ABI mismatches
        # Place 'requirements_clearml.txt' in your repo (committed) and it will be installed remotely.
